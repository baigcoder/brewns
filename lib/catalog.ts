/* Brewns shared product catalogue, locations, delivery rules, and pricing logic.
   Shared across customer frontend, server API, and staff console so prices and
   menu data are always in sync. */
...
export type ProductOption = {
  ...
  wrap?: boolean;
  plain?: boolean;
  choices: [label: string, delta: number, badge?: string][];
};

export type Product = {
  id: string;
  name: string;
  cat: 'beans' | 'drinks' | 'bakery' | 'merch' | 'gifts' | 'coolers' | 'kitchen';
  station: 'bar' | 'kitchen';
  price: number;
  ...
  care?: string;
  menuCat?: 'burgers' | 'pasta' | 'rolls' | 'pizza' | 'drinks';
  art?: [string, string];
};

export const MILK: ProductOption = {
  key: 'milk',
  label: 'MILK',
  choices: [
    ['WHOLE', 0],
...
export const MEAL: ProductOption = {
  key: 'meal',
...
export const SPICE: ProductOption = {
  key: 'spice',
  label: 'SPICE',
  def: 1,
  choices: [
...
export const PIZZA_SIZE: ProductOption = {
  key: 'size',
  label: 'SIZE',
  def: 1,
  choices: [
...
export const COOLER_SIZE: ProductOption = {
  key: 'size',
  label: 'SIZE',
  choices: [
    ['REGULAR', 0],
...
export const RAW_KITCHEN: Omit<Product, 'cat' | 'station'>[] = [
  {
    id: 'smash-burger',
    ...
    tag: 'HOUSE FAVOURITE',
    price: 1350,
    meta: 'DOUBLE SMASHED BEEF · CHEDDAR · HOUSE SAUCE',
    notes: ['JUICY', 'CRISPY EDGES'],
  ...
  },
  {
    ...
    art: ['burger', 'zinger'],
    price: 1150,
    meta: 'BUTTERMILK FRIED CHICKEN · SLAW · MAYO',
    notes: ['CRUNCHY', 'SPICY'],
  ...
  },
  {
    ...
    art: ['burger', 'bbq'],
    price: 1550,
    meta: 'BEEF · ONION RINGS · SMOKED BBQ',
    notes: ['SMOKY', 'STICKY'],
  ...
  },
  {
    ...
    art: ['pasta', 'alfredo'],
    price: 1450,
    meta: 'CREAM · PARMESAN · GRILLED CHICKEN',
    notes: ['CREAMY', 'COMFORT'],
  ...
  },
  {
    ...
    menuCat: 'pasta',
    art: ['pasta', 'arrabbiata'],
    price: 1250,
    meta: 'TOMATO · GARLIC · CHILLI · BASIL',
    notes: ['FIERY', 'VEGETARIAN'],
  ...
  {
    id: 'pesto-pasta',
    name: 'PESTO CHICKEN FUSILLI',
    menuCat: 'pasta',
    art: ['pasta', 'pesto'],
    tag: 'NEW',
    price: 1550,
    meta: 'BASIL PESTO · CHICKEN · PARMESAN',
    notes: ['FRESH', 'HERBY'],
  ...
  },
  {
    ...
    tag: 'LAHORE CLASSIC',
    price: 650,
    meta: 'CHARGRILLED TIKKA · MINT CHUTNEY · ONION',
    notes: ['SMOKY', 'CHUTNEY'],
    ...
    details: [
      ['WRAP', 'LACHHA PARATHA'],
      ['FILLING', 'CHICKEN TIKKA'],
      ['CHUTNEY', 'MINT & YOGURT'],
    ],
  },
  {
    id: 'behari-roll',
    name: 'BEHARI KEBAB ROLL',
    menuCat: 'rolls',
    art: ['roll', 'behari'],
    price: 700,
    meta: 'TENDER BEEF BEHARI · ONION · IMLI',
    notes: ['MELT-IN-MOUTH', 'SPICED'],
    desc: 'Thin-sliced beef marinated overnight in papaya and spices, grilled soft, with onion and tamarind chutney in a paratha.',
    options: [SPICE],
    details: [
      ['MEAT', 'BEEF, OVERNIGHT MARINADE'],
      ['WRAP', 'PARATHA'],
      ['CHUTNEY', 'IMLI'],
    ],
  },
  ...
  },
  {
    ...
    menuCat: 'pizza',
    art: ['pizza', 'margherita'],
    price: 1650,
    meta: 'TOMATO · FIOR DI LATTE · BASIL',
    notes: ['CLASSIC', 'VEGETARIAN'],
  ...
  },
  {
    ...
    tag: 'BESTSELLER',
    price: 1850,
    meta: 'FAJITA CHICKEN · PEPPERS · ONION',
    notes: ['SPICED', 'LOADED'],
  ...
  },
  {
    ...
    art: ['pizza', 'pepperoni'],
    price: 1950,
    meta: 'BEEF PEPPERONI · MOZZARELLA · OREGANO',
    notes: ['CRISPY CUPS', 'SAVOURY'],
  ...
  },
  {
    ...
    art: ['drink', 'mango'],
    price: 750,
    meta: 'CHAUNSA MANGO · YOGURT · HONEY',
    notes: ['THICK', 'SEASONAL'],
  ...
  },
  {
    ...
    art: ['drink', 'lime'],
    price: 450,
    meta: 'LIME · SODA · SWEET OR SALTED',
    notes: ['FIZZY', 'REFRESHING'],
...
export const KITCHEN: Product[] = RAW_KITCHEN.map((k) => ({
  ...k,
  cat: k.menuCat === 'drinks' ? 'coolers' : 'kitchen',
  station: k.menuCat === 'drinks' ? 'bar' : 'kitchen',
  photo: `kitchen/${k.id}.jpg?v=2`,
  alt: `The brewns ${k.name.toLowerCase()}`,
  care:
    k.menuCat === 'drinks'
      ? 'Made to order and best within the hour. Ask for less ice or less sugar at the counter.'
      : 'Cooked to order when you arrive or when the rider is five minutes out, so it reaches you hot.',
}));
...
export const PRODUCTS: Product[] = [
  {
    ...
    options: [
      ...
      },
      {
        ...
        choices: [
          ['ONE-TIME', 0],
          ['EVERY 2 WK', 0, 'SAVE 10%'],
          ['EVERY 4 WK', 0, 'SAVE 10%'],
        ],
      },
    ],
    details: [
  ...
  },
  {
    ...
    price: 4800,
    model: 'bag',
    meta: '250 G · WASHED HEIRLOOM · 2100M',
  ...
  },
  {
    ...
    price: 950,
    model: 'cup',
    alt: 'A brewns latte in the black-lidded brewns paper cup',
    meta: '12 OZ · BREWED DAILY · TO GO',
  ...
  },
  {
    ...
    price: 650,
    model: 'cup',
    alt: 'A brewns espresso in the short black-lidded brewns paper cup',
    meta: 'SINGLE SHOT · SHORT · STRONG',
  ...
  },
  {
    ...
    tag: 'BARISTA PICK',
    price: 850,
    photo: 'menu/menu-cortado.webp',
    model: 'glass',
    alt: 'A brewns cortado in a faceted glass with steamed microfoam',
    meta: '4.5 OZ · EQUAL PARTS ESPRESSO & MILK',
    notes: ['VELVETY', 'HAZELNUT'],
    ...
    details: [
      ...
      ['GLASS', '4.5 OZ GIBRALTAR'],
      ['ORIGIN', 'SLOW ROAST BLEND'],
    ],
  ...
  },
  {
    ...
    tag: 'ON TAP',
    price: 1100,
    photo: 'menu/menu-cold-brew.webp',
    model: 'glass',
    alt: 'A nitro cold brew coffee in a chilled glass with creamy cascading head',
    meta: 'STEEPED 20 HRS · NITROGEN INFUSED',
    notes: ['STOUT-LIKE', 'CREAMY CACAO'],
    ...
    options: [
      ...
      },
      {
        ...
        choices: [
          ['STRAIGHT NITRO', 0],
          ['VANILLA SWEET CREAM', 150],
        ],
      },
    ],
    details: [
      ['STEEP TIME', '20 HOURS COLD'],
      ['INFUSION', 'PURE NITROGEN'],
  ...
  },
  {
    ...
    tag: 'NEW',
    price: 1150,
    photo: 'menu/menu-iced-coffee.webp',
    model: 'glass',
    alt: 'A brewns iced matcha in a clear cup with a straw',
    meta: 'CEREMONIAL GRADE · OVER ICE',
    notes: ['GRASSY', 'CREAMY'],
  ...
  },
  {
    ...
    station: 'bar',
    price: 1050,
    photo: 'menu/menu-iced-latte.webp',
    model: 'glass',
    alt: 'A brewns iced latte in a clear cup',
    meta: 'DOUBLE SHOT · COLD MILK',
    notes: ['BOLD', 'SMOOTH'],
  ...
  },
  {
    ...
    tag: 'NORDIC RITUAL',
    price: 750,
    photo: 'menu/menu-cardamom.webp',
    model: 'bakery',
    alt: 'A freshly baked Swedish cardamom bun with pearl sugar',
    meta: 'STONEGROUND CARDAMOM · BROWN SUGAR',
    notes: ['AROMATIC', 'BUTTERY'],
    ...
    details: [
      ['BAKED', 'DAILY AT 06:30'],
      ['SPICE', 'GUATEMALAN CARDAMOM'],
      ['WEIGHT', '135 G'],
    ],
  ...
  },
  {
    ...
    station: 'bar',
    price: 700,
    photo: 'menu/menu-cinnamon.webp',
    model: 'bakery',
    alt: 'A glazed cinnamon roll on a ceramic plate',
    meta: 'BAKED EVERY MORNING',
    notes: ['BROWN BUTTER', 'CARDAMOM'],
  ...
  },
  {
    ...
    tag: 'GLUTEN-FREE',
    price: 650,
    photo: 'menu/menu-financier.webp',
    model: 'bakery',
    alt: 'A golden-green matcha financier cake with dusted icing sugar',
    meta: 'ALMOND FLOUR · UJI MATCHA',
    notes: ['NUTTY', 'EARTHY SWEET'],
  ...
  },
  {
    ...
    tag: 'ESSENTIAL',
    price: 6500,
    photo: 'menu/menu-tumbler.webp',
    model: 'cup',
    alt: 'A matte ceramic travel tumbler with spill-resistant lid',
    meta: '12 OZ · CERAMIC LINED · DOUBLE WALL',
    notes: ['TRUE TASTE', '6 HR HEAT RETENTION'],
  ...
  },
  {
    ...
    price: 2500,
    gift: true,
    meta: 'DIGITAL · NEVER EXPIRES',
    notes: ['ALL LOCATIONS', 'SENT BY EMAIL'],
...
export const defaultSel = (p: Product): Record<string, number> =>
  Object.fromEntries(p.options.map((o) => [o.key, o.def ?? 0]));

export const isSub = (p: Product, sel: Record<string, number>): boolean =>
  p.options.some((o) => o.key === 'plan') && (sel.plan ?? 0) > 0;

export const basePrice = (p: Product, sel: Record<string, number>): number =>
  p.options.reduce(
    (sum, o) => sum + (o.choices[sel[o.key] ?? 0]?.[1] || 0),
    p.price
  );

export const unitPrice = (p: Product, sel: Record<string, number>): number =>
  basePrice(p, sel) * (isSub(p, sel) ? 0.9 : 1);

export const selLabel = (p: Product, sel: Record<string, number>): string =>
  p.options
    .map((o) => o.choices[sel[o.key] ?? 0]?.[0])
    .filter(Boolean)
    .join(' · ');

export const LOCS: [string, string][] = [
  ['MM ALAM ROAD', 'GULBERG III, LAHORE'],
  ['CCA, DHA PHASE 5', 'DHA, LAHORE'],
  ['MAIN BOULEVARD', 'JOHAR TOWN, LAHORE'],
];

export const LOC_TITLES = [
  'MM Alam Road',
  'CCA, DHA Phase 5',
...
export const TAX = 0.16; // Punjab Sales Tax on Cash (16%)
export const TAX_CARD = 0.05; // Punjab Sales Tax on Card / Digital Wallet (5%)
export const PREP_MIN = 12;
export const OPEN_MIN = 7 * 60; // 07:00
export const CLOSE_MIN = 21 * 60; // 21:00

export type DeliveryArea = [name: string, shop: number, fee: number, eta: number];

export const DELIVERY: { min: number; freeOver: number; areas: DeliveryArea[] } = {
  min: 1000,
  freeOver: 3000,
  areas: [
    ['GULBERG', 0, 150, 30],
    ['MODEL TOWN', 0, 250, 40],
    ['GARDEN TOWN', 0, 200, 35],
    ['DHA PHASE 1–6', 1, 200, 35],
    ['DHA PHASE 7–8', 1, 300, 45],
    ['JOHAR TOWN', 2, 150, 30],
    ['WAPDA TOWN', 2, 250, 40],
  ],
};

export const PAY: [label: string, atShop: string, atDoor: string][] = [
...
export const pkMobile = (v: string): string => {
